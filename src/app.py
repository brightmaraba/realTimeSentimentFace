...
from sentiment_pipline import SentimentAnalysisPipeline
from utils import create_sentiment_image
...
class App(customtkinter.CTk):
    def __init__(self, sentiment_analysis_pipeline: SentimentAnalysisPipeline) -> None:
        ...
        self.sentiment_text_var.trace_add(
            "write", lambda *_: self.on_sentiment_text_changed()
        )
